                  ...
                  <div className="flex justify-center">
                    <div className="relative w-3/4">
                      <input ref={this.inputRef}  
                             ...
                             className="block p-2.5 w-full z-20 text-sm rounded-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" 
